...
This document gives a quick tour of **MHMMR** (version `r packageVersion("MHMMR")`) functionalities. It was written in R Markdown, using the [knitr](https://cran.r-project.org/package=knitr) package for production. 
